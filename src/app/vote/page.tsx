      ...
      <>
        ...
        <div className="relative flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <div className="text-white text-xl font-medium">Loading your delicious experience...</div>
          </div>
        </div>
      </>
    );
        ...
        <div className="sticky top-0 z-50 backdrop-blur-xl bg-white/5 border-b border-white/10">
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex justify-between items-center">
              ...
              <button
                onClick={() => signOut()}
                className="group bg-red-500/20 hover:bg-red-500/30 text-red-300 hover:text-red-200 px-6 py-2 rounded-full border border-red-500/30 transition-all duration-300 backdrop-blur-sm"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-20">
            <div className="inline-block mb-8">
              <PointerHighlight>
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-white via-purple-200 to-purple-300 bg-clip-text text-transparent leading-tight">
            ...
            {Object.entries(todaysMenu).map(([mealType, items]) => (
              <div key={mealType} className="group">
                ...
                <div className="text-center mb-12">
                  <div className="inline-flex items-center space-x-4 bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm rounded-full px-8 py-4 border border-white/20 mb-6">
                    <span className="text-4xl">{mealIcons[mealType as keyof typeof mealIcons]}</span>
                    <h2 className="text-3xl md:text-4xl font-bold text-white capitalize tracking-wide">
                      {mealType}
                    </h2>
                  </div>
